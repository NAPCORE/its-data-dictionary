...
- External identifiers (e.g., for OpenStreetMap (KeyList), NeTEx ID, European Access ID, IFOPT)
...
- The reference for postal address format is INSPIRE.
- The reference for road address is NeTEx. 
