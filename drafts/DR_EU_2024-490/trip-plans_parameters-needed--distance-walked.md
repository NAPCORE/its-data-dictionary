---
id: trip-plans_parameters-needed--distance-walked
label: parameters needed to calculate an environmental factor such as greenhouse gas emissions per vehicle type or passenger mile or per distance walked
